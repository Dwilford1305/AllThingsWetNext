          ...
          >
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl flex items-center justify-center text-gray-300 hover:text-blue-400 transition-all duration-200 hover:shadow-lg hover:bg-white/20"
                aria-label="Facebook"
              >
